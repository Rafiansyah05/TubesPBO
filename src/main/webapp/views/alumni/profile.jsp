                ...
                <div>
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button onclick="document.getElementById('modalJob').style.display='flex'" class="btn btn-gold" style="width: auto; padding: 10px 20px; font-size: 14px;">
                                    ...
                                    <c:forEach var="job" items="${jobs}">
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <form action="${pageContext.request.contextPath}/alumni/profile" method="post" onsubmit="return confirm('Hapus pekerjaan ini?')">
    ...
    <div id="modalJob" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 2000; align-items: center; justify-content: center;">
        <div class="auth-card" style="max-width: 600px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h3 style="font-weight: 800; color: var(--primary);">Tambah Riwayat Pekerjaan</h3>
                <button onclick="document.getElementById('modalJob').style.display='none'" style="background: none; border: none; font-size: 24px; cursor: pointer;">&times;</button>
            </div>
            <form action="${pageContext.request.contextPath}/alumni/profile" method="post">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div class="form-group">
                        <label>Jabatan</label>
                        <input type="text" name="jabatan" class="form-control" placeholder="Software Engineer" required>
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
